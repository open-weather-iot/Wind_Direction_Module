...
class HMC5883L:
    ...
    # Correction to be set after calibration, use HMC5882Lcalibration.py
    xs=1
    ys=1
    xb=0
    yb=0
    ...
    def __init__(self, scl=15, sda=14, address=0x1e, gauss='1.9', declination=(-21, 38)): 
